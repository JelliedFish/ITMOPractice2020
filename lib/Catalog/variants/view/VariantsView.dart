  ...
  Widget buildGridView(BuildContext context) {
    return Container(
      ...
      child: GridView.count(
        crossAxisCount: 3,
        children: <Widget>[
          new Item(0.75, "75%", Color.fromRGBO(239, 87, 83, 1), _variantsPresenter.catalogPresenter),
          new Item(0.34, "34%", Color.fromRGBO(131, 34, 167, 1), _variantsPresenter.catalogPresenter),
          new Item(0.34, "34%", Color.fromRGBO(131, 34, 167, 1), _variantsPresenter.catalogPresenter),
          new Item(0.75, "75%", Color.fromRGBO(239, 87, 83, 1), _variantsPresenter.catalogPresenter),
          new Item(0.34, "34%", Color.fromRGBO(131, 34, 167, 1), _variantsPresenter.catalogPresenter),
          new Item(0.34, "34%", Color.fromRGBO(131, 34, 167, 1), _variantsPresenter.catalogPresenter),
